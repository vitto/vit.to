...
$(function () {
  ...
  add(1, 'hello')
  add(2, 'i\'m', 0, true)
  add(0.5, ['vittorio vittori', 'glad to see you here'], [2, 1])
  add(2, ['i live in', 'i work in'], [1.3, 1.2], true)
  add(0, ['forlì', 'cesena'], [1.3, 1.2])
  add(2, '_', 0, true)
  ...
  add(2, 'i use', 0, true)
  add(0.5, ['agile method', 'bem', 'user stories'], [0.75, 0.875, 1])
  add(2, 'currently @', 0, true)
  add(0.5, ['flowing srl', 'flowing srl'], [0.875, 0.875])
  add(2, '_', 0, true)
  add(0.5, 'this is', 0, true)
  add(0.125, ['my homepage', 'my visual style', 'cyberpunk'], [0.75, 1, 0.6])
  add(2, 'i love', 0, true)
  add(0.5, ['video-games', 'my dogs', 'growing bonsais', 'experimenting with code', 'visual design', 'tdr'], [0.85, 1.1, 1, 1.25, 1, 1.12])
